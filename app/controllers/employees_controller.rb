  ...
  private
    ...
    def employee_params
      params.require(:employee).permit(:sal_number, :job_number, :record_number, :workshop, :group, :name, :sex, :birth_date, :birth_year, :age, :nation, :native_place, :political_role, :political_party_date, :working_time, :railway_time, :entry_time, :duty, :employment_period, :part_time, :grade, :promotion_leader_time, :technique_duty,
       ...
       :marriage_status, :separate_status, :visit_family, :registered_residence, :family_address, :comment, :identity_card_number, :employee_card_number, :trade_code, :produce_group, :saler_item, :other_saler, :comment_data, :graduation_time, :position, :group_category, :job_foreman_category, :job_foreman_duty, :avatar)
    end
